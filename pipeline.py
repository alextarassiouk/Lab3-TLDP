...
PROJECT_ID = 'tldp-etl-lab-489021'  # Replace with your GCP project ID
OUTPUT_DIR = 'output'
...
def transform(df: pd.DataFrame) -> pd.DataFrame:
    ...
    print(df[['tag', 'total_questions', 'engagement_score']].head(10))
